...
void si446x_set_modem(void) {
	...
	si446x_busy_wait_send_receive(16, 0, (uint8_t [16]){0x11, 0x20, 0x0C, 0x24, 0x03, 0x06, 0x55, 0x03, 0x08, 0x02, 0x00, 0x00, 0x00, 0x12, 0xC0, 0x02}, rx_buffer);
	...
	si446x_busy_wait_send_receive(9, 0, (uint8_t [9]){0x11, 0x20, 0x05, 0x45, 0x03, 0x00, 0xBD, 0x02, 0x00}, rx_buffer);
	...
	si446x_busy_wait_send_receive(6, 0, (uint8_t [6]){0x11, 0x20, 0x02, 0x54, 0x03, 0x07}, rx_buffer);
	//Configure signal arrival detect - WDS settings
	si446x_busy_wait_send_receive(9, 0, (uint8_t [9]){0x11, 0x20, 0x05, 0x5B, 0x42, 0x08, 0x09, 0x78, 0x20}, rx_buffer);
	//Configure first and second set of Rx filter coefficients - (Used matlab to configure two sets of settings, 1.03kHz and then 0.44kHz after AFC has settled)
	...
	si446x_busy_wait_send_receive(16, 0, (uint8_t [16]){0x11, 0x21, 0x0C, 0x0C, 0xFC, 0xFD, 0x15, 0xFF, 0x00, 0x0F, 0x0C, 0x01, 0xE4, 0xB9, 0x86, 0x55}, rx_buffer);
	si446x_busy_wait_send_receive(16, 0, (uint8_t [16]){0x11, 0x21, 0x0C, 0x18, 0x2B, 0x0B, 0xF8, 0xEF, 0xEF, 0xF2, 0xF8, 0xFC, 0x05, 0x00, 0xFF, 0x0F}, rx_buffer);
