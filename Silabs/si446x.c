...
void si446x_set_modem(void) {
	...
	si446x_busy_wait_send_receive(16, 0, (uint8_t [16]){0x11, 0x21, 0x0C, 0x00, 0xFF, 0xF7, 0x23, 0x86, 0x0D, 0x1F, 0xB2, 0x07, 0x90, 0xED, 0x3A, 0x11}, rx_buffer);
	si446x_busy_wait_send_receive(16, 0, (uint8_t [16]){0x11, 0x21, 0x0C, 0x0C, 0xE9, 0xF4, 0xD5, 0x03, 0x0F, 0x0F, 0xFF, 0xBA, 0x0F, 0x51, 0xCF, 0xA9}, rx_buffer);
