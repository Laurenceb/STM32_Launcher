    ...
    // INPUT DATA
    /*
    // Crys_freq(Hz): 26000000    Crys_tol(ppm): 1    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 1    ANT_DIV: 0    PM_pattern: 0    
    // MOD_type: 2    Rsymb(sps): 200    Fdev(Hz): 300    RXBW(Hz): 500    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
    // RF Freq.(MHz): 434.75    API_TC: 29    fhst: 3000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
    // API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0    
    //
    // # RX IF frequency is  -406250 Hz
    // # WB filter 1 (BW =   0.52 kHz);  NB-filter 1 (BW = 0.52 kHz)
    //
    // Modulation index: 3
    */
    ...
    */
    #define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x07, 0x8F, 0xD5, 0x00, 0x00, 0x02, 0xC0, 0x08, 0x00, 0x12, 0x80, 0x28
    ...
    */
    #define RF_MODEM_RAW_CONTROL_5 0x11, 0x20, 0x05, 0x45, 0x03, 0x00, 0x99, 0x02, 0x00
    ...
    */
    #define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x43, 0x09, 0x00, 0x00, 0x00, 0xF2, 0x20, 0xFE
    ...
    */
    #define RF_PKT_CRC_CONFIG_7 0x11, 0x12, 0x07, 0x00, 0x04, 0x00, 0x30, 0xFF, 0xFF, 0x20, 0x02
    ...
    */
    #define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x07, 0x04, 0xAA, 0x00, 0x00, 0x00
    ...
    */
    ...
    //   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
    */
    #define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x00, 0x07, 0xD0, 0x01, 0x8C, 0xBA, 0x80, 0x00, 0x00
    ...
    */
    ...
    //   MODEM_BCR_OSR_0 - RX BCR/Slicer oversampling rate (12-bit unsigned number).
    */
    #define RF_MODEM_TX_RAMP_DELAY_12_1 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xF0, 0x10, 0x74, 0xE8, 0x00, 0x55
    ...
    //   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for AFC functionality.
    */
    #define RF_MODEM_BCR_NCO_OFFSET_2_12_1 0x11, 0x20, 0x0C, 0x24, 0x06, 0x0C, 0xAB, 0x03, 0x03, 0x02, 0xC2, 0x00, 0x04, 0x32, 0xC0, 0x01
    ...
    //   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
    */
    #define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x03, 0x64, 0xC0
    ...
    */
    ...
    //   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
    */
    #define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x13, 0x13, 0x80, 0x1A, 0xC0, 0x00, 0x00, 0x28, 0x0C, 0xA4, 0x22
    ...
    //   MODEM_RSSI_CONTROL - Control of the averaging modes and latching time for reporting RSSI value(s).
    */
    #define RF_MODEM_RAW_CONTROL_8 0x11, 0x20, 0x08, 0x45, 0x83, 0x04, 0x6C, 0x02, 0x00, 0xFF, 0x06, 0x22
    ...
    */
    ...
    //   MODEM_ONE_SHOT_AFC - Configures parameters for th e One Shot AFC function and for BCR timing/acquisition.
    */
    #define RF_MODEM_SPIKE_DET_2_1 0x11, 0x20, 0x02, 0x54, 0x0F, 0x07
    ...
    */
    ...
    //   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
    */
    #define RF_MODEM_DSA_CTRL1_5_1 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x21, 0x78, 0x20
    ...
    */
    ...
    //   FREQ_CONTROL_VCOCNT_RX_ADJ - Adjust target count for VCO calibration in RX mode.
    */
    #define RF_FREQ_CONTROL_INTE_8_1 0x11, 0x40, 0x08, 0x00, 0x41, 0x0F, 0x13, 0xB1, 0x00, 0xF2, 0x20, 0xFE
