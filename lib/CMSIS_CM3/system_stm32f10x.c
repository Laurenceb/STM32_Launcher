...
*******************************************************************************/
  ...
  const uint32_t SystemFrequency_APB1Clk = (SYSCLK_FREQ_48MHz/16);  /*!< APB Peripheral bus 1 (low)  speed   */
  const uint32_t SystemFrequency_APB2Clk = (SYSCLK_FREQ_48MHz/4);      /*!< APB Peripheral bus 2 (high) speed   */
